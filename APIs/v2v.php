<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET')
    {
        ...
        $SqlCommand = "SELECT MAX(message_id) FROM v2v_messages";
        ...
        $Query = "INSERT INTO v2v_messages (message_id , reference, reciever_id, ". 
        "sender_id, content, message_priority, message_date_time , message_status, ".
        "latitude, longitude, location) ".
        "VALUES ($MessageID, '$Reference', '$ReceiverID', ".
